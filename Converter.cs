...
namespace OOP_Exam
{
    ...
    { 
        ...
        const double UAHtoUSD = 1 / 27.8485;
        const double UAHtoEUR = 1 / 32.7986;
        const double UAHtoRUB = 1 / 0.3377;

        public void ValueConverter()
        {
            Console.Write(
                "Из какой валюты производить конвертацию:\n" +
                "1.UAH\n" +
                "2.USD\n" +
                "3.EUR\n" +
                "4.RUB\n" +
            ...
            Console.Write(
                "В какую валюту производить конвертацию:\n" +
                "1.UAH\n" +
                "2.USD\n" +
                "3.EUR\n" +
                "4.RUB\n" +
